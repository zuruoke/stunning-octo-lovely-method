 ...
 * @returns Post[]
 */
const merge_posts = (lists_of_post) => {
    /*
        initialize global variables
    */
    let post_list = []; // the post array to be returned
    let memo = {}; // induces the memoization technique
    let temp = {
        id: 0,
        description: "",
        image: "",
...
exports.merge_posts = merge_posts;
